...
//console.log(a); // Ele não altera os valores que estão fora, usando o let
...
const { name: prodcutName, price, category, color } = productDetails;

console.log(
  `O nome do produto é ${prodcutName}, eçe custa R$$ ${price} e é da cor ${color}.`
);
